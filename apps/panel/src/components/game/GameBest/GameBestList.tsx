...
import { useFetchGameResultWithoutFetchGame } from "../../../features/games/hook";
...
export const GameBestList = (props: GameBestListProps) => {
  const { result, isFetching, refresh } = useFetchGameResultWithoutFetchGame(
    props.game,
    true
  );
  ...
  if (!result) {
    //  todo Nayu: replace this component
    return <p>503 Service Unavailable</p>;
  }

...
export const GamePointBar = (props: GamePointBarProps) => {
  ...
  const isMyTeamPlay =
    props.myTeamId === leftTeamId || props.myTeamId === rightTeamId;
  ...
  const backgroundColor = isMyTeamPlay
    ? `${theme.palette.warning.main}66`
    : isMyTeamUmpire
    ? `${theme.palette.success.main}66`
    : `${theme.palette.text.disabled}33`;
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box>
            <ThemeProvider theme={{ direction: "rtl" }}>
              <PointBar variant={"determinate"} value={leftScore * barOffset} />
            </ThemeProvider>
          </Box>
        </Stack>
        ...
        >
          ...
          <Box>
            <PointBar variant={"determinate"} value={rightScore * barOffset} />
          </Box>
        </Stack>
      </Button>
      <SwipeableDrawer

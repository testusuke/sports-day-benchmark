...
export default function Page() {
  return (
    <Stack
      ...
      alignItems="center"
      sx={{ background: "radial-gradient(ellipse at left, #5F6DC2, #3E4EB3)" }}
    >
      <Stack justifyContent="center" alignItems="center" spacing={1}>
        <Typography fontSize={"20px"} fontWeight={"bold"} color={"#EFF0F8"}>
          みんなの球技大会
        </Typography>
        <Stack direction={"row"} spacing={0.5} pl={1.5} pb={2}>
          <Typography
            fontSize={"20px"}
            fontWeight={"bold"}
            color={"#EFF0F8"}

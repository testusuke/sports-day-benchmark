          ...
          >
            ...
            >
              ...
              <Typography fontSize={"18px"}>
                SPORTSDAY TEAMでは、お客様の利用状況を把握するためにGoogle
                Analyticsを利用しています。
              </Typography>
              <Typography fontSize={"18px"}>
                SPORTSDAYが発行するクッキーをもとにして、Google
                inc.がお客様のSPORTSDAYへの訪問履歴を収集、記録、分析します。SPORTSDAY
                TEAMは、Google
                inc.からその分析結果を受け取り、お客様のSPORTSDAYへの訪問状況を把握します。
              </Typography>
              <Typography fontSize={"18px"}>
                Google
                Analyticsにより収集、記録、分析されたお客様の情報には、特定の個人を識別する情報は一切含まれません。また、それらの情報は、Google
            ...
            >
              ...
              <Typography fontSize={"18px"}>
                CopyRight 2023 SPORTSDAY TEAM All Rights Reserved, Licensed
                under Apache-2.0.
              </Typography>
              <Typography fontSize={"18px"} pb={8}>
                NEXT.JSはVercel, Inc. KotlinはKotlin Foundation Google
                AnalyticsはGoogle, Inc. MotionはFramerの商標または商品名です。
              </Typography>
              <Typography fontSize={"26px"} fontWeight={"bold"} pb={2}>
                Heroicons
              </Typography>
              ...
              <Typography fontSize={"18px"}>
                ...
                Cole Bemis 2013-2022 as part of Feather (MIT). All other

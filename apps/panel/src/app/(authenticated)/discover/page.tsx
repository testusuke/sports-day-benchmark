...
import { useFetchTeamSetsInMyClass } from "@/features/unit/discover";
import { Loading } from "@/components/layouts/loading";
import { motion } from "framer-motion";
import { useFetchLocations } from "@/features/locations/hook";
import { useFetchImages } from "@/features/images/hook";
...
import { useFetchGames } from "@/features/games/hook";
...
export default function DiscoverPage() {
  ...
  //  Unit Hook
  const { isFetching, isSuccessful, matchSets } = useFetchTeamSetsInMyClass();
                ...
                >
                  {!isSuccessful && (
                    <OtherInfo
                      ...
                      infoSubContent={
                        "どの競技にも参加していません。参加予定にも関わらずこのメッセージが表示されている場合は、お近くのスタッフにお伝えください。"
                      }
                    />
                  )}
                  <Box
